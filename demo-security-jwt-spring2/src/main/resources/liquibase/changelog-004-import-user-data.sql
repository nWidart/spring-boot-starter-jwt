...
--changeset admin:changelog-004-import-user-data logicalFilePath:changelog-004-import-user-data.sql failOnError:true

INSERT INTO user (id, name, password, email, admin_flag)
VALUES (1, 'kamimura', '{bcrypt}$2a$10$yiIGwxNPWwJ3CZ0SGAq3i.atLYrQNhzTyep1ALi6dbax1b1R2Y.cG', 'kkamimura@example.com',
        TRUE);
INSERT INTO user (id, name, password, email, admin_flag)
